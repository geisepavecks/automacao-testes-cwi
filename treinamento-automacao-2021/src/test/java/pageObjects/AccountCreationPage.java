...
public class AccountCreationPage extends AccountCreationPageElementMapper {
    ...
    @Step("Preencheu address first name")
    public void fillAddressFirstName(String name) {
        addressFirstName.sendKeys(name);
    }

    @Step("Preencheu address last name")
    public void fillAddressLastName(String name) {
